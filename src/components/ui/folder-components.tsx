...
// NOTE: adapted from the source for Tailwind v3 — gradient utility renamed
// (bg-gradient-to-b), mask written as an arbitrary property, and the `lg`
// non-standard spacings converted to arbitrary rem values.
...
> = {
  ...
  lg: {
    ...
    tabLeft: "w-16 h-[1.375rem] rounded-tl-xl",
    tabRight: "w-[0.8125rem] h-[1.375rem] rounded-tr-[40px]",
    tabBridge: "w-[0.8125rem] h-[0.8125rem]",
    flapBody: "h-16",
      ...
      <div className="absolute right-0 bottom-0 left-0 z-20">
        <div className="flex items-end">
          ...
          <div
            className={cn(
              s.tabBridge,
              "[mask-image:radial-gradient(200%_200%_at_100%_0%,transparent_50%,black_50%)]",
              c.flap
            )}
          />
        </div>
